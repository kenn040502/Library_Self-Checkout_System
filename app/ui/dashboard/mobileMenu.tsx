...
// Full per-role nav surfaced inside the hamburger drawer. Mirrors the desktop
// sidebar exactly — same labels, same icons, same vertical order. Keep these
// arrays in sync with ADMIN_NAV / STAFF_NAV / USER_NAV in sidenav.tsx.
const FULL_NAV: Record<DashboardRole, DrawerItem[]> = {
  user: [
    ...
    { label: 'My Books',          href: '/dashboard/my-books',           icon: BookmarkIcon },
