...
export default function QuickCheckInButton({
  ...
  const confirmationDialog = open ? (
    ...
    >
      ...
      {/* Panel */}
      <div className="relative max-h-[calc(100dvh-2rem)] w-full max-w-md overflow-y-auto rounded-card border border-hairline bg-surface-card p-6 shadow-[0_4px_16px_rgba(20,20,19,0.08)] dark:border-dark-hairline dark:bg-dark-surface-card">
        {/* Warning icon */}
  ...
  return (
    <>
      ...
      {confirmationDialog ? createPortal(confirmationDialog, document.body) : null}
    </>
  );
}
